...
export const CategoryDropdown = ({category, isActive, isNavigationHovered}: Props) => {
    ...
    const onMouseEnter = () => {if(category.subcategories ) setIsOpen(true);}
    ...
    return (
        ...
        >
            <div className="relative">
                ...
                variant="elevated"
                className={cn(
                    "h-11 px-4 border-transparent rounded-full hover:bg-white hover:border-primary text-black", isActive && !isNavigationHovered && "bg-white border-primary"
                )}>
                    {category.name}
                </Button>
